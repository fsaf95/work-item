  ...
  export default {
    data() {
      return {
        ...
        errorImg:'this.src="' + require('@/assets/images/errorimg.png') + '"',    //引入图片
      }
    },
    filters:{
      moneyFilter(money){
    ...
    methods:{
      getCategory() {
        ...
        .then(response=>{
          ...
          if(response.data.code == 200 && response.data.message ){
            ...
            // this.category[0].ID是通过数组索引取得默认的第一个分类的ID值
      ...
      getGoodList(){
        axios({
          url: url.getGoodsListByCategorySubID,     //后台的路径
          method:'post',                            //读取
          data:{                                    //转递的数据
